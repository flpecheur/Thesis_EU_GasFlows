...
process_total_data(lng_dict, ['2019_01', '2019_02', '2019_03','2019_04','2019_05','2019_06','2019_07','2019_08','2019_09','2019_10','2019_11','2019_12' ], lng_keys, f'{DIR}/data/opData')

### Layout Definition ###
app.layout = html.Div([
    html.H1(children ='LNG Points Map (2019)', style={'text-align': 'center'}),
    dcc.Graph(
        id='main-map',
