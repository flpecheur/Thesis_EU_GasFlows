...
lng_points_info = pd.read_excel(f'{DIR}/data/points/LNG_points_info.xlsx')     # Update LNG csv based on excel file
...
print(f"ENTSOG Transmission points : {len(trans_points_df)}")
print(f"ENTSOG LNG points : {len(lng_points_df)}")
...
print(f"Final LNG poitns : {len(lng_points_df)}")
### Save data
